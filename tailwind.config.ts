	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				// Web3 brand colors
				web3: {
					'teal-dark': 'hsl(var(--web3-teal-dark))',
			...
			keyframes: {
				...
				'glow': {
					'from': { boxShadow: '0 0 20px hsl(var(--web3-teal) / 0.3)' },
					'to': { boxShadow: '0 0 30px hsl(var(--web3-blue) / 0.4)' }
				},
				'accordion-down': {
					from: {
						height: '0'
			...
			animation: {
				...
				'pulse-web3': 'pulse-web3 2s cubic-bezier(0.4, 0, 0.6, 1) infinite',
